...
class ProjectMemberController extends ApiController
{
    ...
    {
       $members = $this->projectManagerService->indexProjectMember(
        $project,
        $request->user()
       );
    ...
    {
        $user = $this->projectManagerService->createProjectMember(
            $project,
            $request->validated(),
            $request->user()
           );
    ...
    {
        $this->projectManagerService->deleteProjectMember(
            $project,
            $request->user(),
            $userId
        );
