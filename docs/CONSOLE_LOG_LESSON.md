...
**生徒 👩‍💻**：「エラーの時も console.log で確認できるんですか？」

**ガネーシャ 🐘**：「せやで！さっきの fetchTask 関数の catch ブロックにな、console.error を追加するんや」
...
**ガネーシャ 🐘**：「せやろ！console.log と console.error を使いこなせば、**未来の自分を助ける**ことになるんや。ワシの教え子のベンジャミン・フランクリンくんも『時間こそ金なり』って言うとったけど、デバッグ時間を短縮することは**時間を生み出すこと**なんやで」
